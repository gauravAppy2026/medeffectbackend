...
export class ReportsService {
  ...
  async getOverview() {
    ...
    const [
      ...
      this.ivrModel.countDocuments({ status: 'not_covered' }),
    ...
    return {
      ...
      ivr: { total: totalIVR, submitted: submittedIVR, covered: coveredIVR, not_covered: notCoveredIVR, rejected: rejectedIVR },
